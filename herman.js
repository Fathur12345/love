...
function _0x3215()
{
    const _0x407eeb = ['fs-extra', '5wIGyZq', 'textSync', 'cyan', 'Herman', '5874648uQMAhd', 'MENGHUBUNGKAN....!!', 'default', 'base64EncodedAuthInfo', '338tsbohV', 'browserDescription', 'sendMessage', 'stringify', '5572889PmuoKv', 'Firefox', 'level', 'parse', 'The Edge', 'writeFileSync', 'unknown', 'blockUser', './lib/simple', '.json', '13289960bCgWgv', 'WAConnection', '[UPDATE]', './herman.js', 'group-participants-update', 'OWNER AKTIF SEKARANG!..', 'connect', 'red', '17564eoDdfQ', '224qqvXNq', '4078wCayIB', './lib/loader', 'version', '229122UTmQLc', 'SCAN QR NYA BRO....!', 'existsSync', 'yellow', '873mtZsCX', 'green', 'CB:action,,call', 'BOT SUDAH TERHUBUNG!', 'from', 'BOT TIDAK MENERIMA CALL', 'readFileSync', '3.0.0', 'Diubah!', './HermanChanel.js', '23116434WxGOMq', 'sessionName', '[ Herman Chanel ]', 'open', 'loadAuthInfo', 'add', 'log', 'Herman', 'warn'];
    _0x3215 = function ()
    {
        return _0x407eeb;
    };
...
baterai = _0xe27ee1(0x1b4), charging = 'unknown', require('./HermanChanel.js'), nocache('../HermanChanel.js', _0x48b814 => console[_0xe27ee1(0x19e)](color(_0xe27ee1(0x1ba), _0xe27ee1(0x1a4)), color('\'' + _0x48b814 + '\'', _0xe27ee1(0x1ca)), _0xe27ee1(0x196))), require(_0xe27ee1(0x1bb)), nocache('../herman.js', _0x38426a => console[_0xe27ee1(0x19e)](color(_0xe27ee1(0x1ba), _0xe27ee1(0x1a4)), color('\'' + _0x38426a + '\'', _0xe27ee1(0x1ca)), _0xe27ee1(0x196)));
const starts = async (_0x525973 = new WAConnection()) =>
{
    const _0x203dfb = _0xe27ee1;
    _0x525973['logger'][_0x203dfb(0x1b0)] = _0x203dfb(0x1a0), _0x525973[_0x203dfb(0x1c4)] = [0x2, 0x85f, 0x3], console[_0x203dfb(0x19e)](color(figlet[_0x203dfb(0x1a3)]('herman'
    , {
