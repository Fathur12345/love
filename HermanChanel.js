...
rply = '©Herman Botz'
tamnel = fs.readFileSync('./media/herman.jpg')
...
if (!dep.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${Owner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Herman Chanel_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (dep.key.remoteJid.endsWith('@g.us') && offline) {
			if (!dep.key.fromMe){
...
const dfrply = fs.readFileSync('./itsu.jpg')
		...
		const grupinv = (teks) => {
        	grup = itsu.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/LZlPZEVqK3KGKgL5WVtV2h', "groupName": `${BotName}`, "footerText": "*_© Herman Chanel_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const isTTT = isGroup ? idttt.includes(from) : false
		...
		const pporigi = fs.readFileSync('./herman.jpg')
...
const hideTag = async function(from, text){
	       ...
	       gura.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('./media/herman.jpg')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
...
const katalog = (teks) => {
             res = gura.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_©Herman Botz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
...
{buttonId:`.sc`,buttonText:{displayText:'🤤SCRIP🤤'},type:1},
...
${mot} _${prefix}wallgravity text1 text2_
`
gura.sendMessage(from, { contentText: `${test}`, footerText: `©Herman Chanel`, buttons: [{ buttonId: `${prefix}owner`, buttonText: { displayText: '𝘖𝘸𝘯𝘦𝘳 𝘉𝘰𝘵 メ' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: tamnel, contextInfo: {mentionedJid: [sender, ownerNumber]}}}, 'buttonsMessage')
break
...
break
case 'audio':
case 'audiomenu': //by herman chanel
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
itsu = await gura.getStatus(`${sender.split('@')[0]}@s.whatsapp.net`, MessageType.text)
const emenul = `
${tampilUcapan} - @${sender.split("@")[0]}
...
➤ *Audio Menu🗿*
${mot} _${prefix}audio1_
${mot} _${prefix}audio2_
${mot} _${prefix}audio3_
${mot} _${prefix}audio4_
${mot} _${prefix}audio5_
${mot} _${prefix}sc_
_Atau pilih Button Di Bawah_`
emenulun = [
{buttonId:`.audio1`,buttonText:{displayText:'AUDIO 1'},type:1},
{buttonId:`.audio2`,buttonText:{displayText:'AUDIO 2'},type:1},
{buttonId:`.audio3`,buttonText:{displayText:'AUDIO 3'},type:1},
{buttonId:`.audio4`,buttonText:{displayText:'AUDIO 4'},type:1},
{buttonId:`.audio5`,buttonText:{displayText:'AUDIO 5'},type:1}
]
mhan = await gura.prepareMessage(from, pporigi, image, {thumbnail: pporigi})
const emenun = {
imageMessage: mhan.message.imageMessage,
...
case 'sc':
case 'sourcecode':
reply('*_https://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg\n SUBSCRIBE ANJ🗿_*')
const Peli = fs.readFileSync('./lagu/subrek.mp3');//Case by Herman Chanel
gura.sendMessage(from, Peli, MessageType.audio, {quoted: fakevo, mimetype: 'audio/mp4', ptt:true})//By Herman Chanel
break
...
break
case 'audio1' ://By Herman Chanel
man = fs.readFileSync('./lagu/audio1.mp3');
gura.sendMessage(from, man, MessageType.audio, {quoted: fakevo, mimetype: 'audio/mp4', ptt:true})
but = [
{ buttonId: '!menu', buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
{ buttonId: '!sc', buttonText: { displayText: 'SCRIP' }, type: 1 }
]
sendButton(from, "herman Chanel", faketeks, but, dep)
break
case 'audio2' ://By Herman Chanel
man = fs.readFileSync('./lagu/audio2.mp3');
gura.sendMessage(from, man, MessageType.audio, {quoted: fakevo, mimetype: 'audio/mp4', ptt:true})
but = [
{ buttonId: '!menu', buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
{ buttonId: '!sc', buttonText: { displayText: 'SCRIP' }, type: 1 }
...
sendButton(from, "herman Chanel", faketeks, but, dep)
break
case 'audio3' ://By Herman Chanel
man = fs.readFileSync('./lagu/audio3.mp3');
gura.sendMessage(from, man, MessageType.audio, {quoted: fakevo, mimetype: 'audio/mp4', ptt:true})
but = [
{ buttonId: '!menu', buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
{ buttonId: '!sc', buttonText: { displayText: 'SCRIP' }, type: 1 }
...
sendButton(from, "herman Chanel", faketeks, but, dep)
break
case 'audio4' ://By Herman Chanel
man = fs.readFileSync('./lagu/audio4.mp3');
gura.sendMessage(from, man, MessageType.audio, {quoted: fakevo, mimetype: 'audio/mp4', ptt:true})
but = [
{ buttonId: '!menu', buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
{ buttonId: '!sc', buttonText: { displayText: 'SCRIP' }, type: 1 }
...
sendButton(from, "herman Chanel", faketeks, but, dep)
break
case 'audio5' ://By Herman Chanel
man = fs.readFileSync('./lagu/audio5.mp3');
gura.sendMessage(from, man, MessageType.audio, {quoted: fakevo, mimetype: 'audio/mp4', ptt:true})
but = [
{ buttonId: '!menu', buttonText: { displayText: 'BACK TO MENU' }, type: 1 },
{ buttonId: '!sc', buttonText: { displayText: 'SCRIP' }, type: 1 }
